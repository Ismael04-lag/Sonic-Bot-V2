...
async function generateBankCard(opts = {}) {
    const {
        title = "CARD", balance = "0", username = "USER",
        cardData = null, cvv = null, avatarUrl = null,
        theme = "dark", subtitle = "", note = ""
    } = opts;
